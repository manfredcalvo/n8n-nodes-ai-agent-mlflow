...
exports.AgentWithMLFlow = void 0;
            ...
            async searchExperiments() {
                ...
                try {
                    ...
                    if (response.experiments && Array.isArray(response.experiments)) {
                        results.results = response.experiments.map((exp) => ({
                            name: exp.name,
...
exports.AgentWithMLFlow = AgentWithMLFlow;
//# sourceMappingURL=AgentWithMLFlow.node.js.map