 ...
 */
export declare const SpanAttributeKey: {
 ...
 */
export declare const TraceMetadataKey: {
    SOURCE_RUN: string;
    MODEL_ID: string;
    SIZE_BYTES: string;
 ...
 */
export declare const TraceTagKey: {
 ...
 */
export declare const TRACE_ID_PREFIX = "tr-";
/**
 ...
 */
export declare const NO_OP_SPAN_TRACE_ID = "no-op-span-trace-id";
/**
 * Constants for token usage keys (matching Python TokenUsageKey)
 */
export declare const TokenUsageKey: {
    INPUT_TOKENS: string;
 ...
 */
export declare const REQUEST_RESPONSE_PREVIEW_MAX_LENGTH = 1000;
