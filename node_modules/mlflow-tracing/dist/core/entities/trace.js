...
const trace_info_1 = require("./trace_info");
const trace_data_1 = require("./trace_data");
/**
...
class Trace {
    ...
    static fromJson(json) {
        const info = trace_info_1.TraceInfo.fromJson(json.info);
        const data = trace_data_1.TraceData.fromJson(json.data);
